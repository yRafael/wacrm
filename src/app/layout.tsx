...
import { SecurityLayer } from '@/components/security/security-layer';
import {
  DEFAULT_MODE,
  DEFAULT_THEME,
  MODE_STORAGE_KEY,
...
export const metadata: Metadata = {
  title: {
    default: 'Fire Workspace',
    template: '%s — Fire Workspace',
  },
  description: 'Workspace de atendimento e operação da Fire Play.',
  robots: {
    index: false,
    follow: false,
  },

...
const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
  not_found: {
    ...
    body: 'Este link não corresponde a um convite válido. Confira a URL ou peça à pessoa que convidou você que envie um novo.',
  },
  used: {
  ...
  server_error: {
    ...
    body: 'Não foi possível verificar este convite agora. Tente recarregar a página em instantes.',
  },
};

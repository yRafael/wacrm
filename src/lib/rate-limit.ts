...
export const RATE_LIMITS = {
  ...
  /** Fire Control step-up re-authentication, per IP. Password
   *  attempts against the operator account — tight enough to make
   *  brute force useless, loose enough that a human retyping a
   *  password is never blocked. */
  stepUp: { limit: 5, windowMs: 60_000 },

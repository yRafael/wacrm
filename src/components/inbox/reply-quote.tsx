  ...
  return (
    <div
      className={cn(
        ...
        onPrimary
          ? 'border-[var(--bubble-sent-quote-border)]'
          : 'border-primary',
        isChip
          ? 'bg-muted/80 rounded-md'
          : onPrimary
            ? 'mb-1.5 rounded-md bg-[var(--bubble-sent-soft)]'
      ...
      <div className="min-w-0 flex-1 overflow-hidden">
        <div
          className={cn(
            ...
            onPrimary ? 'text-[var(--bubble-sent-text)]' : 'text-primary'
          )}
        >
          {authorLabel}
        </div>
        ...
        <div
          className={cn(
            ...
            onPrimary ? 'text-[var(--bubble-sent-time)]' : 'text-foreground/80'
          )}
        >
          {preview}
        </div>

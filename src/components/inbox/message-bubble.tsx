    ...
    <div className={cn('flex flex-col', isAgent ? 'items-end' : 'items-start')}>
      <div
        className={cn(
          ...
          isAgent
            ? 'rounded-br-md bg-[var(--bubble-sent-bg)] text-[var(--bubble-sent-text)]'
            : 'rounded-bl-md bg-[var(--bubble-received-bg)] text-[var(--bubble-received-text)]'
        )}
      >
        {reply && (
          <ReplyQuote
        ...
        >
          ...
          {message.ai_generated && (
            <span
              className="inline-flex items-center gap-0.5 rounded-full bg-[var(--bubble-sent-soft)] px-1.5 py-px text-[9px] leading-none font-semibold tracking-wide text-[var(--bubble-sent-text)] uppercase"

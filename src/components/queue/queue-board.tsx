    ...
    <section className="border-border bg-card flex flex-col rounded-xl border">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center gap-1 px-4 py-8 text-center">
          <p className="text-muted-foreground text-sm">{t(`${bucket}Empty`)}</p>
...
function QueueRow({
  ...
  return (
    <li>
      <div className="hover:bg-muted/50 flex items-center justify-between gap-3 px-4 py-3 transition-colors">
        ...
        <Link
          ...
          title={t('open')}
        >
          <span className="bg-muted text-foreground flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-xs font-medium">
            {initial}
          </span>
        ...
        <span className="flex shrink-0 items-center gap-2">
          {c.unread_count > 0 && (
            <span className="bg-primary text-primary-foreground flex h-5 min-w-5 items-center justify-center rounded-full px-1 text-[10px] font-bold tabular-nums">
              {c.unread_count}
            </span>
          )}
          {timeAgo && (
